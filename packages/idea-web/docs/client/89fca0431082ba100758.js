...
`,!1)]).element]}};var ar=k(N()),Xr=k(P()),ct=k(G()),de=class extends Xr.default{static id="0ab1bce486b32e7cdafc";static tagname="docs";static classname="Docs_0ab1bce486b32e7cdafc";styles(){return""}template(){return(0,ct.classlist)().add("block","w-full","h-full","scroll-y-auto","scroll-x-hidden"),()=>[ar.default.createText(`
`,!1),ar.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,ct.children)())]).element]}};var l=k(N()),ss=k(P());var L=k(N()),ts=k(P()),nr=k(es()),rs=k(G()),U=class extends ts.default{static id="5387662ecbed97347dd0";static tagname="code";static classname="Code_5387662ecbed97347dd0";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`)),i?T=T.trim():d?T=T.replace(/^\s+/,""):h&&(T=T.replace(/\s+$/,""));let A=_=>{if(!T)return;let w=nr.default.highlight(T,nr.default.languages[r],r);if(_.detail.target.innerHTML=w,a){let C=w.match(/\n(?!$)/g),o=C?C.length+1:1,c=new Array(o+1).join("<span></span>"),p=document.createElement("span");p.setAttribute("aria-hidden","true"),p.className="line-numbers-rows",p.innerHTML=c,_.detail.target.appendChild(p)}};return()=>[L.default.createElement("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css"}).element,L.default.createText(`
...
app.engine('ink', view(compiler));`}}};var ue=class extends ss.default{static id="2b08d18966ac07e0669a";static tagname="ui";static classname="Ui_2b08d18966ac07e0669a";styles(){return""}template(){(0,Q.classlist)().add("block","my-40","scroll-hidden","curved","shadow-0-0-10-0-0-0-5");let{start:t="InkCompiler"}=(0,Q.props)(),r=(0,Q.signal)([t]),a=(0,Q.signal)(t),n=d=>{let h=d.target.getAttribute("data-type");r.value=[...r.value,h],a.value=h},i=()=>{r.value=r.value.slice(0,r.value.length-1),a.value=r.value[r.value.length-1]};return()=>[l.default.createText(`
...
`,!1),l.default.createElement("div",{class:"bg-t-0 p-10"},[l.default.createText(`
  `,!1),l.default.createElement("div",{class:"relative mb-20 scroll-auto"},[l.default.createText(`
    ...
    `,!1)]).element,l.default.createText(`
  `,!1)]).element,l.default.createText(`
`,!1)]).element]}};var Me=k(N()),as=k(P()),dt=k(G()),me=class extends as.default{static id="d13ac870c734c1e59a80";static tagname="head";static classname="Head_d13ac870c734c1e59a80";styles(){return""}template(){return(0,dt.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[Me.default.createText(`
...
`,!1)]).element]}};var Pe=k(N()),ns=k(P()),ut=k(G()),fe=class extends ns.default{static id="effc05807fc7bfd0b111";static tagname="left";static classname="Left_effc05807fc7bfd0b111";styles(){return""}template(){return(0,ut.classlist)().add("absolute","top-0","bottom-0","left-0","w-170","bg-t-3","b-solid","b-t-2","by-0","bl-0","br-1","z-2"),()=>[Pe.default.createText(`
...
`,!1)]).element]}};var Fe=k(N()),is=k(P()),mt=k(G()),he=class extends is.default{static id="dd8105a02de18136d611";static tagname="main";static classname="Main_dd8105a02de18136d611";styles(){return""}template(){return(0,mt.classlist)().add("absolute","top-45","right-0","left-170","bottom-0","bg-black","b-solid","b-t-2","bx-0","bb-0","bt-1"),()=>[Fe.default.createText(`
...
`,!1)]).element]}};var I=k(N()),ls=k(P()),ft=k(G()),xe=class extends ls.default{static id="4ec139eab67151540039";static tagname="app";static classname="App_4ec139eab67151540039";styles(){return""}template(){let{title:t,height:r}=(0,ft.props)(),a=r?`height:${r}px`:"";return()=>[I.default.createText(`
`,!1),I.default.createElement("div",{class:"curved scroll-hidden shadow-0-0-10-0-0-0-5"},[I.default.createText(`
  `,!1),I.default.createElement("div",{class:"relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16"},[I.default.createText(`
    `,!1),I.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,I.default.createText(`
    `,!1),I.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,I.default.createText(`
    `,!1),I.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,I.default.createText(`
    `,!1),I.default.createElement("span",{class:"flex flex-center h-full w-full absolute top-0 left-0"},[I.default.createText(`
      `,!1),...this._toNodeList(t),I.default.createText(`
    `,!1)]).element,I.default.createText(`
  `,!1)]).element,I.default.createText(`
  `,!1),I.default.createElement("div",{class:"bg-black tx-t-1 relative",style:a},[...this._toNodeList((0,ft.children)())]).element,I.default.createText(`
`,!1)]).element]}};var $=k(N()),os=k(P());var v=function(s,...t){let r=ir(s);for(let a=0;a<t.length;a++)r=r.replace("%s",String(t[a]));return r},ir=function(s){return s};var ge=class extends os.default{static id="794a00a5e900fca28310";static tagname="translate";static classname="Translate_794a00a5e900fca28310";styles(){return""}template(){let{trim:t=!1,p:r=!1,li:a=!1,div:n=!1}=this.props,i=this.originalChildren,d=[],h=[];for(let A of i)typeof A=="string"?d.push(A):A instanceof Node&&A.textContent?d.push(A.textContent):(d.push("%s"),h.push(A));let y=d.join("");t&&(y=y.replace(/\s+/," ").trim());let E=ir(y).split("%s"),T=[];for(let A=0;A<E.length;A++)T.push(document.createTextNode(E[A])),h[A]&&T.push(h[A]);return()=>[$.default.createText(`
...
`,!1),e.default.createElement("html",{},[e.default.createText(`
  ...
  `,!1),e.default.createElement("link",{rel:"favicon",href:"/idea/favicon.ico"}),e.default.createText(`
  `,!1),e.default.createElement("link",{rel:"shortcut icon",type:"image/png",href:"/idea/favicon.png"}),e.default.createText(`
  ...
  `,!1),e.default.createElement("link",{rel:"stylesheet",type:"text/css",href:"/idea/styles/global.css"}),e.default.createText(`
  `,!1),e.default.createElement("link",{rel:"stylesheet",type:"text/css",href:`/idea/client/${(0,ht.env)("BUILD_ID")}.css`}),e.default.createElement("script",{"data-template":!0,type:"text/json"},[e.default.createText("__TEMPLATE_DATA__",!0)]),e.default.createText(`
  `,!1),e.default.createElement("script",{src:`/idea/client/${(0,ht.env)("BUILD_ID")}.js`}),e.default.createText(`
...
`,!1)]),e.default.createText(`
  ...
  `,!1),...t!=="/idea/index.html"&&t!=="/idea/500.html"?[e.default.createText(`
  ...
  `,!1)]:[,e.default.createText(`
    `,!1),e.default.createElement("a",{href:"/idea"},[e.default.createText(`
      `,!1),e.default.createElement("img",{alt:"Ink Logo",class:"h-26 mr-10",src:"/idea/ink-icon.png"}),e.default.createText(`
    `,!1)]),e.default.createText(`
  `,!1)],e.default.createText(`
...
`,!1)])]),e.default.createText(`
  ...
  `,!1),e.default.createElement("a",{href:"/idea"},[e.default.createText(`
    `,!1),e.default.createElement("img",{class:"h-26 mr-10",src:"/idea/ink-icon.png",alt:"Ink Logo"}),e.default.createText(`
  `,!1)]),e.default.createText(`
  `,!1),e.default.createElement("h3",{class:"flex-grow m-0 tx-upper"},[e.default.createText(`
    `,!1),e.default.createElement("a",{class:"tx-primary",href:"/idea"},[e.default.createText("Ink",!1)]),e.default.createText(`
  `,!1)]),e.default.createText(`
...
`,!1)])]),e.default.createText(`
    ...
    `,!1)]),e.default.createText(`
  `,!1)]),e.default.createText(`
`,!1)])]}},Ga={PanelLayout_c4c96a14064fc0c4d224:te,ElementAlert_ba827f6c1d3753161701:ae,ElementIcon_33cb84912ffcb000a388:ne,ElementTab_773b62de7e46341aea2d:le,ApiDocs_0ab1bce486b32e7cdafc:de,ApiUi_2b08d18966ac07e0669a:ue,ApiIdeCode_5387662ecbed97347dd0:U,AppHead_d13ac870c734c1e59a80:me,AppLeft_effc05807fc7bfd0b111:fe,AppMain_dd8105a02de18136d611:he,IdeApp_4ec139eab67151540039:xe,IdeCode_5387662ecbed97347dd0:U,I18nTranslate_794a00a5e900fca28310:ge},us={"panel-layout":te,"element-alert":ae,"element-icon":ne,"element-tab":le,"api-docs":de,"api-ui":ue,"app-head":me,"app-left":fe,"app-main":he,"ide-app":xe,"ide-code":U,"i18n-translate":ge},Ja="89fca0431082ba100758";xt.default.once("ready",()=>{gt.sync();for(let[s,t]of Object.entries(us))customElements.getName(t)||customElements.define(s,t);xt.default.emit("mounted",document.body)});return Es(Wa);})();
