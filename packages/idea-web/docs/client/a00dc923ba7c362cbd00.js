...
`,!1)]).element]}};var L=w(q()),zr=w(Y()),it=w(de()),fe=class extends zr.default{static id="4ec139eab67151540039";static tagname="app";static classname="App_4ec139eab67151540039";styles(){return""}template(){let{title:e,height:r}=(0,it.props)(),s=r?`height:${r}px`:"";return()=>[L.default.createText(`
...
`,!1)]).element]}};var C=w(q()),Ur=w(Y()),Kt=w(Br()),Gr=w(de()),me=class extends Ur.default{static id="5387662ecbed97347dd0";static tagname="code";static classname="Code_5387662ecbed97347dd0";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`,!1)]}};var Vt=w(q()),Wr=w(Y()),ot=w(de()),he=class extends Wr.default{static id="62eb1e835132946fd19f";static tagname="preview";static classname="Preview_62eb1e835132946fd19f";styles(){return""}template(){return(0,ot.classlist)().add("block","w-full","h-full","scroll-auto"),()=>[Vt.default.createText(`
`,!1),Vt.default.createElement("div",{class:"bg-white tx-black arial p-10 h-full"},[...this._toNodeList((0,ot.children)())]).element]}};var z=w(q()),Yr=w(Y());var M=function(a,...e){let r=Qt(a);for(let s=0;s<e.length;s++)r=r.replace("%s",String(e[s]));return r},Qt=function(a){return a};var pe=class extends Yr.default{static id="794a00a5e900fca28310";static tagname="translate";static classname="Translate_794a00a5e900fca28310";styles(){return""}template(){let{trim:e=!1,p:r=!1,li:s=!1,div:n=!1}=this.props,i=this.originalChildren,f=[],_=[];for(let A of i)typeof A=="string"?f.push(A):A instanceof Node&&A.textContent?f.push(A.textContent):(f.push("%s"),_.push(A));let b=f.join("");e&&(b=b.replace(/\s+/," ").trim());let E=Qt(b).split("%s"),x=[];for(let A=0;A<E.length;A++)x.push(document.createTextNode(E[A])),_[A]&&x.push(_[A]);return()=>[z.default.createText(`
    ...
    `,!1)]]}};var S=w(q()),Jr=w(Y()),ct=w(de()),ge=class extends Jr.default{static id="214815192b7b83049a32";static tagname="tweet-box";static classname="TweetBox_214815192b7b83049a32";styles(){return`a, a:link, a:hover, a:active, a:visited {
    color: var(--info);
    text-decoration: none;
  }
  :host {
...
`,!1),S.default.createElement("main",{class:"tweet-box"},[S.default.createText(`
  ...
  `,!1)]).element,S.default.createText(`
`,!1)]).element,S.default.createText(`
`,!1)]}};var ut=w(de());var ft=class a extends Zr.default{static sync(){return new a().sync()}template(){let e="/idea/index.html",r=M("Ink - The reactive web component template engine."),s=M("Ink is a template engine that generates web components and support reactivity.");return[t.default.createText(`
`,!1),t.default.createElement("html",{},[t.default.createText(`
  ...
  `,!1),t.default.createElement("link",{rel:"favicon",href:"/idea/favicon.ico"}),t.default.createText(`
  `,!1),t.default.createElement("link",{rel:"shortcut icon",type:"image/png",href:"/idea/favicon.png"}),t.default.createText(`
  ...
  `,!1),t.default.createElement("link",{rel:"stylesheet",type:"text/css",href:"/idea/styles/global.css"}),t.default.createText(`
  `,!1),t.default.createElement("link",{rel:"stylesheet",type:"text/css",href:`/idea/client/${(0,ut.env)("BUILD_ID")}.css`}),t.default.createElement("script",{"data-template":!0,type:"text/json"},[t.default.createText("__TEMPLATE_DATA__",!0)]),t.default.createText(`
  `,!1),t.default.createElement("script",{src:`/idea/client/${(0,ut.env)("BUILD_ID")}.js`}),t.default.createText(`
...
`,!1)]),t.default.createText(`
  ...
  `,!1),...e!=="/idea/index.html"&&e!=="/idea/500.html"?[t.default.createText(`
  ...
  `,!1)]:[,t.default.createText(`
    `,!1),t.default.createElement("a",{href:"/idea"},[t.default.createText(`
      `,!1),t.default.createElement("img",{alt:"Ink Logo",class:"h-26 mr-10",src:"/idea/ink-icon.png"}),t.default.createText(`
    `,!1)]),t.default.createText(`
  `,!1)],t.default.createText(`
...
`,!1)])]),t.default.createText(`
      `,!1),t.default.createElement("main",{class:"scroll-auto"},[t.default.createText(`
        `,!1),t.default.createElement("section",{class:"bg-t-1 py-40 tx-center w-full"},[t.default.createText(`
          `,!1),t.default.createElement("img",{class:"h-100",src:"/idea/ink-logo.png",alt:"Ink Logo"}),t.default.createText(`
          ...
          `,!1)]),t.default.createText(`
          `,!1),t.default.createElement("element-button",{primary:!0,xl:!0,rounded:!0,class:"mr-10",href:"/idea/docs/getting-started.html"},[t.default.createText(`
    ...
    `,!1)]),t.default.createText(`
  `,!1)]),t.default.createText(`
`,!1)])]}},Os={PanelLayout_c4c96a14064fc0c4d224:ne,ElementButton_8b2d9633875784010957:le,IdeApp_4ec139eab67151540039:fe,IdeCode_5387662ecbed97347dd0:me,IdePreview_62eb1e835132946fd19f:he,I18nTranslate_794a00a5e900fca28310:pe,TweetBox_214815192b7b83049a32:ge},Qr={"panel-layout":ne,"element-button":le,"ide-app":fe,"ide-code":me,"ide-preview":he,"i18n-translate":pe,"tweet-box":ge},Ns="a00dc923ba7c362cbd00";dt.default.once("ready",()=>{ft.sync();for(let[a,e]of Object.entries(Qr))customElements.getName(e)||customElements.define(a,e);dt.default.emit("mounted",document.body)});return na(Ds);})();
